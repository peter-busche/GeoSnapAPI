...
Rails.application.routes.draw do
  ...
  namespace :web do
    ...
    resources :images, only: [:index, :show, :new] #Can be removed as all images are related to specific users

    # Session management routes
    get '/login', to: 'sessions#new', as: :login                      #define '/login' and attach it to new() in sessions_controller.rb
